...
export const Hero = () => {
  ...
  return (
    <section className={`relative min-h-screen flex items-center justify-center px-6 pt-28 pb-12 overflow-hidden ${isNeo ? 'bg-[#FFFDF6]' : isSwiss ? 'bg-white' : isGlass ? 'bg-transparent' : 'bg-slate-950'}`}>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          >
            Hi, I'm <span className={isNeo ? "text-[#590696] font-black underline decoration-wavy decoration-3 underline-offset-4" : isSwiss ? "text-[#D82B27] font-black uppercase" : isGlass ? "text-[#1A2E1F] font-bold" : "text-white font-semibold"}>{userData.name}</span>. {userData.bio}
          </motion.p>
          <motion.div
          ...
          >
            <a 
              ...
              className={isNeo 
                ...
                : isSwiss
                  ...
                  : isGlass
                    ? "px-8 py-4 bg-[#6B4EFF] hover:bg-[#5038E0] text-white font-glass-sans font-bold rounded-xl transition-all duration-200 shadow-[0_6px_20px_rgba(107,78,255,0.32)] hover:translate-y-[-2px] hover:shadow-[0_12px_32px_rgba(107,78,255,0.38)]"
            ...
            <div className="flex gap-4">
              ...
              <a 
                href="https://www.instagram.com/s.a.u.r.a.b_/" 
                target="_blank" 
                rel="noopener noreferrer" 
