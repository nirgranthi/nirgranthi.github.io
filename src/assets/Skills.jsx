...
export const Skills = () => {
  ...
  return (
    <section id="skills" className={`py-24 px-6 ${isNeo ? 'bg-[#FFFDF6] border-t-4 border-black' : isSwiss ? 'bg-white border-t border-black' : isGlass ? 'bg-transparent border-t border-white/50 border-b border-white/10' : isNeomorphic ? 'bg-[#e0e5ec] border-t border-[#cfd6e0]' : 'bg-slate-900/30'}`}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className={isNeo ? "text-4xl font-black text-black mb-6 uppercase tracking-wider" : isSwiss ? "text-4xl font-black text-black mb-6 uppercase tracking-tighter" : isGlass ? "font-glass-serif text-4xl md:text-5xl text-[#1A2E1F] mb-6 tracking-[-0.02em]" : isNeomorphic ? "font-neo-display text-4xl md:text-5xl text-[#1a202c] mb-6 tracking-[-0.01em]" : "text-4xl font-bold text-white mb-6"}>Technical Arsenal</h2>
          <p className={isNeo || isSwiss ? "text-black/85 font-bold max-w-2xl mx-auto" : isGlass ? "font-glass-sans text-[#3D4F3F] text-base md:text-lg max-w-2xl mx-auto" : isNeomorphic ? "font-neo-body text-[#4a5568] text-base md:text-lg max-w-2xl mx-auto" : "text-slate-400 max-w-2xl mx-auto"}>
              ...
              className={isNeo
                ...
                : isSwiss
                  ...
                  : isGlass
                    ...
                    : isNeomorphic
                      ? "neo-raised-heavy p-6 flex flex-col items-center hover:translate-y-[-2px] transition-all duration-300"
              ...
              <h3 className={isNeo
                ...
                : isSwiss
                  ...
                  : isGlass
                    ...
                    : isNeomorphic
                      ? "font-neo-display text-lg text-[#1a202c] mb-6 font-bold border-b border-slate-300/40 w-full text-center pb-2"
                    ...
                    className={isNeo
                      ...
                      : isSwiss
                        ...
                        : isGlass
                          ...
                          : isNeomorphic
                            ? "px-3 py-1.5 font-neo-body text-[13px] font-semibold bg-[#e0e5ec] text-[#4a5568] rounded-full neo-sunken hover:text-[#2f66ff] transition-all duration-150"
