    ...
    ${isNeo
        ...
        : isSwiss
            ...
            <div className={isNeomorphic
                ? "neo-raised-heavy max-w-[1200px] mx-auto px-8 py-3.5 flex justify-between items-center rounded-[50px] transition-all duration-300"
                : isGlass
                ...
                <div className={isNeo 
                    ...
                    : isSwiss
                        ...
                        : isGlass
                            ...
                            : isNeomorphic
                                ? "text-2xl font-neo-display font-bold text-[#1a202c] select-none"
                    ...
                    {isGlass ? (
                        ...
                        <>
                            {userData.username}
                            <span className="text-[#2f66ff] font-bold">.</span>
                        </>
                    ) : (
                        userData.username + "."
                    )}
                ...
                {/* Desktop Menu */}
                <div className={`hidden md:flex space-x-6 items-center ${isNeo || isSwiss ? 'text-black' : isGlass ? 'text-[#7A8C7C]' : isNeomorphic ? 'text-[#4a5568]' : 'text-slate-300 font-medium'}`}>
                            ...
                            className={isNeo 
                                ...
                                : isSwiss
                                    ...
                                    : isGlass
                                        ...
                                        : isNeomorphic
                                            ? "text-[13px] font-neo-body font-semibold text-[#4a5568] hover:text-[#1a202c] py-2 px-4 rounded-[20px] hover:neo-sunken transition-all duration-150"
                    ...
                    ${isNeo 
                        ...
                        : isSwiss
                            ...
                            : isGlass
                                ...
                                : isNeomorphic
                                    ? 'neo-raised-heavy max-w-[1200px] mx-auto mt-4 px-6 py-6 rounded-3xl flex flex-col space-y-3'
                            ...
                            className={isNeo 
                                ...
                                : isSwiss
                                    ...
                                    : isGlass
                                        ...
                                        : isNeomorphic
                                            ? "text-[#4a5568] text-center font-neo-body font-semibold text-sm border border-[#fff]/30 bg-[#e0e5ec] px-4 py-2.5 rounded-full hover:neo-sunken"
